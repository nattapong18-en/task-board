...
### ภาพที่ 3 — รันเว็บไซต์ของเราและของเพื่อนบนเครื่องเรา

รัน Mini Task Board ของเราที่ port `8080` และเว็บไซต์ Noodle Foyer ของเพื่อนที่ port `8081` พร้อมกันบนเครื่อง Linux เครื่องเดียวกัน

![เว็บไซต์ของเราและของเพื่อนรันพร้อมกัน](docs/images/no4.3.png)

คำสั่ง `docker compose ps` แสดง container ของเว็บไซต์เพื่อนอยู่ในสถานะ `Up` และเปิดผ่าน port `8081`

![Container เว็บไซต์ของเพื่อน](docs/images/4.4.png)

### หลักฐานเพิ่มเติม — นำเว็บไซต์ของเราไปรันบนเครื่องอื่น
...
> **หมายเหตุเรื่องข้อมูล:** เวอร์ชันนี้ยังไม่มีระบบสมัครสมาชิกหรือเข้าสู่ระบบ และข้อมูลใน D1 ไม่ได้แยกตามผู้ใช้ ทุกคนที่มีลิงก์จะเห็นและสามารถเพิ่ม แก้ไข หรือลบรายการงานชุดเดียวกันได้ จึงไม่ควรใช้เก็บข้อมูลส่วนตัวหรือข้อมูลสำคัญ
